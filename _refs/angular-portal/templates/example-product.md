...
Reference output from a complete `angular-portal-init-entity` invocation against `product`. Use this to verify the shape and conventions of the generated bundle; do NOT copy-paste — let SKILL.md emit the parameterized templates from `entity-skeleton.md`.
