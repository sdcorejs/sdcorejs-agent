---
artifact_id: plan-draft-visual-companion-offer-r1
artifact_kind: plan
schema_version: 1
...
plan_context:
  ...
  self_review:
    ...
    validation_map_authority: pending explicit plan approval; no fabricated approved decision-coverage receipt
    validation_map_pending_code: DECISION_COVERAGE_APPROVAL_INVALID
