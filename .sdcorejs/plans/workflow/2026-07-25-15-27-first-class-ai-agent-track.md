---
artifact_id: plan-contract-first-class-ai-agent-track-20260725-r1
artifact_kind: plan
...
description: Approved implementation plan for the first-class ai-agent track and sdcorejs-ai-agent executor.
approvedAt: 2026-07-25T15:27:39+07:00
...
prohibited_paths:
  ...
  - dist/**
  - build/**
  - sensitive provider/runtime evidence
  - target runtime repositories outside the approved root
dependency_changes:
  required: false
...
# First-class AI Agent Track - Approved Plan
