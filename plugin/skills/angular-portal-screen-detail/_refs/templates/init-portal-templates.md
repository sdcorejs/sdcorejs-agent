...
Sidebar branding + menu. The `sidebar.logoUrl` is served from `public/logo.png` (file copied verbatim from `_refs/assets/logo.png` during generation — replace per project without touching code).
