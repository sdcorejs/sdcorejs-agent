...
## When invoked
- After a `21-screen-detail` / `22-screen-create` / `23-screen-update` / `31-workflow-actions` skill completes
...
- Build skills that produce testable code: `tracks/angular-portal/10-init-portal.md` → `31-workflow-actions.md`
