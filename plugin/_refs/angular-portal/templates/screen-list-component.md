...
Code template referenced from [`20-screen-list.md`](../../20-screen-list.md). The skill body owns the rules and decision logic (server-paging vs client, external filters, audit columns, score cards, etc.); this file holds the literal `list.component.ts` body the skill emits.
