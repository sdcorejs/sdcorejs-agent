# Entity Skeleton Templates — angular-portal-init-entity

This file holds the canonical Angular code templates the `angular-portal-init-entity` skill generates. SKILL.md picks which template to use based on the chosen layout variant; the actual code lives here so SKILL.md stays under 500 lines.
