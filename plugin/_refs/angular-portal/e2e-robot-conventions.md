...
Reference for generating Angular-portal E2E tests in **Robot Framework**, the stack the QC/Automation team uses (`nsp-automation-test`). Loaded on demand by `testing/e2e/angular-portal.md` when the target project is a Robot Framework suite. For Cypress/Playwright, the skill body covers it directly.
