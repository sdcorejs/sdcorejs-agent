# Test-Integration Knowledge — Angular Portal

> Integration patterns loaded on demand by `sdcorejs-test` when the project is an
...
Read `_refs/shared/testing-philosophy.md` first for principles.
...
### MUST DO
- Inherit principles from `_refs/shared/testing-philosophy.md` (AAA, naming, what-to-mock)
