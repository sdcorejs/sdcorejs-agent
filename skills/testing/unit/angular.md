---
name: sdcorejs-testing-unit-angular
description: Use to write unit tests for Angular-portal — pure validators, mappers, pipes, single-service-method tests with mocked dependencies. Different from `testing/integration/angular.md` (wires multiple collaborators). Inherits cross-track principles from `testing/philosophy.md`. Triggers - "unit test angular", "test validator", "test pipe", "test service method", "test pure function", or automatic invocation after a reactive-form / service skill completes. Bilingual (VI/EN).
...
## When invoked
- After the `angular-write-code` orchestrator (screen-detail pack) adds validators / form refinement, or pure utility code lands
...
- Integration tests: `testing/integration/angular.md`
- E2E tests: `testing/e2e/angular.md`
