...
## When invoked
- After the `angular-write-code` orchestrator (screen-detail pack, any state, or actions pack) completes
...
- Unit tests: `testing/unit/angular.md`
