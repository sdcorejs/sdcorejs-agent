...
This catalog is generated from `@sd-angular/core@19.0.0-beta.86`. Canonical MD lives next to each source file in `vn-angular/projects/sd-angular/<path>/`; this folder is a byte-identical mirror. When the library version changes, regenerate or re-sync from canonical.
