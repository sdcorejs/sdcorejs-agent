...
This skill installs **technical SEO**: metadata factory, JSON-LD builders, sitemap, robots, favicons. It does NOT cover **on-page SEO** (heading hierarchy, keyword placement, internal linking, content length, title/description length warnings, Article schema authoring, bilingual translation quality). Those belong to `19-content-quality`. Dispatch both for a complete SEO setup — technical SEO alone gets you indexed; on-page SEO is what makes you rank.
...
- On-page SEO + Article schema: `19-content-quality` (heading hierarchy, content length, Article JSON-LD with author + dates)
