---
name: angular-portal-review-code
description: Use to review generated or modified code against SDCoreJS Angular Portal conventions. Outputs a structured Strengths / Issues report sorted Critical → Important → Minor with file:line refs. Triggers - "review code", "check module X", "audit module", "review changes", "rà soát code". Bilingual (VI/EN).
