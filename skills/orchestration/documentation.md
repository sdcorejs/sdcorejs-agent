...
| `write-user-guide` | user guide, user manual, module guide, aggregate guide, DOCX/PDF export, verified real-UI screenshots, legacy reverse-engineer guide | `_refs/documentation/write-user-guide.md` |
