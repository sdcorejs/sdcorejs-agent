...
- Watch for `@sdcorejs/angular` imports — the project's UI baseline. Cross-reference `_refs/angular-portal/sdcorejs-angular-catalog.md` when listing components in use.
