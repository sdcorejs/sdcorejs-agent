...
For `@sd-angular/core` specifically — read `skills/angular-portal/_refs/core-version.md`. If the target project pins to a version, do NOT upgrade unilaterally; ask the user and update the reference doc together.
