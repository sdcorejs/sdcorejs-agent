...
- `_shared/debug` — for single-bug fix workflow (use when the input isn't a structured findings list)
- `_shared/verify-before-done` — final gate AFTER this loop converges
- `_shared/commit` — handoff destination after convergence
