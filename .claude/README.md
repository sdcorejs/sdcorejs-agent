...
- Concern-based layout (`skills/tracks/<stack>/` + `skills/orchestration/` + `skills/shared/` + `skills/review/` + `skills/testing/`) gives clear workflow ordering via numeric prefixes (`00-onboarding.md`, `07-write-code.md`, `31-actions.md`) — the flat `.claude/skills/<name>/SKILL.md` layout doesn't.
