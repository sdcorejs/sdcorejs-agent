...
## When invoked
- The resolved execution contract includes the `i18n` feature
...
```tsx executable-reference=copy-ready
...
```tsx executable-reference=partial-example
...
```json executable-reference=partial-example
