...
Source of truth for **WHY** SDCoreJS landing sites look the way they do. Loaded on demand by `sdcorejs-brainstorm`, `sdcorejs-write-spec`, the `sdcorejs-nextjs` orchestrator (theme / pages-and-blocks / seo / i18n packs), and `sdcorejs-review`.
