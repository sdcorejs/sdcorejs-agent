...
See `_refs/sd-angular-core-catalog.md` for the full inventory.
...
- `_refs/core-version.md` — pinned `@sd-angular/core` version
- `_refs/sd-angular-core-catalog.md` — Core UI components inventory
- `_refs/entity-field-types.md` — field-type → form-control mapping
- `_refs/templates/entity-skeleton.md` — canonical code templates these principles produce
- `_refs/templates/example-product.md` — worked example end-to-end
