...
description: Use when adding a new entity (with full CRUD pages - model, service, routes, list, detail) into an existing module. Triggers - "thêm entity X vào module Y", "add entity", "create CRUD for X", "tạo CRUD entity", "generate entity". Bilingual (VI/EN).
