...
1. **Site name + tagline (1 dòng)**
   - Example: "Vật liệu Xây dựng Mỹ Hoà — Đối tác tin cậy của mọi công trình"
   - Used in: `<title>`, OG image, hero, JSON-LD

2. **Production domain (URL chính thức)**
   - Example: `https://myhoa.vn`, `https://acme.com`
...
| **Tier** | Standard |
| **Tên + tagline** | "Vật liệu XD Mỹ Hoà — Đối tác tin cậy" |
| **Domain** | https://myhoa.vn |
| **Languages** | VI (EN structure ready) |
| **Logo + brand** | logo.svg cung cấp; màu đỏ cam #ea580c + xám đậm |
| **Contact email** | sales@myhoa.vn (reply-to user's email) |
...
- Save durable answers (domain, hosting, analytics) — these are project-level and should propagate to `_shared/memories`
