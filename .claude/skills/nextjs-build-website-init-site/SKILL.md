...
| `lucide-react` | Icon set (matches website_myhoa baseline; consistent across project) |
...
- `_shared/env-setup` covers post-clone environment if a teammate joins later
