---
name: angular-portal-faq
description: Use when the developer asks a question about generated code, conventions, or troubleshooting AFTER work is already done - not for fresh generation. Answers from existing skill rules and templates. Triggers - "tại sao", "why", "how does X work", "what's the convention for", "explain why we ...", "vì sao module phải biết trước". Bilingual (VI/EN).
