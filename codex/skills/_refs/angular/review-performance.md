...
- Code review (correctness overlap): `sdcorejs-review` · Repair loop: `sdcorejs-repair-loop`
- Verification: `sdcorejs-ship (verify-before-done mode)` runs probes as criteria
